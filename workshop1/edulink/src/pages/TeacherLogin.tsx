...
import { Users, UserPlus, LogIn, ArrowLeft } from "lucide-react";
        ...
        >
          <div className="text-center mb-8">
            ...
            <p style={{ color: tokens.color.mutedForeground }}>
              {mode === "login" ? "Welcome back! Sign in to manage your classroom." : "Create your teacher account to start sharing."}
            </p>
          </div>
          ...
          <Card>
            {success ? (
              <div className="text-center py-8">
                ...
                <p className="mb-6" style={{ color: tokens.color.mutedForeground }}>
                  {mode === "login"
                    ...
                    : "Your teacher account has been created. You can now sign in."}
                </p>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                {mode === "register" && (
                  <>
                    <Input label="Full Name" placeholder="Mr. John Smith" required />
                    <Input label="School / Institution" placeholder="Springfield High School" required />
                  </>
                )}
                <Input
                  label="Email Address"
